...
namespace Unity.XR.PXR
{
    ...
    {
        /// <summary>
        /// Initializes the enterprise service for a specified object. Must be called before calling other enterprise APIs.初始化指定对象的企业服务。在调用其他企业API之前必须调用。
        /// </summary>
        ...
        /// <summary>
        /// Binds the enterprise service. Must be called before calling other system related functions.绑定企业服务。必须在调用其他系统相关函数之前调用。
        /// </summary>
        /// <param name="callback">
